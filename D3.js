...
while (i < starWarsCharacters.length) {
  EMass += starWarsCharacters[i].mass; 
  i++; 
}

console.log("La massa totale dell'equipaggio è:", EMass);
...
if (crewMass < 500) {
  carico = "Leggero";
} else if (CrewMass >= 500 && CrewMass <= 1000) {
  carico= "Medio";
} else {
  carico = "Pesante";
}
console.log("La tipologia di carico dell'astronave è:", carico);
